...
// $ret = curl("http://www.chanpin100.com/?s=aaa","GET",$params);
...
// while($i < 100000){
// 	$begin = time();
//     $ret = curl("http://loc.meihao.api/v1/courses/7/section","GET",$params);
// 	//$ret = curl("http://student.meihaoxueyuan.com/api/courses/7/section","GET",$params);
...
// var_dump(array_splice($input, 0, -1));
...
// $new_array = array_merge($array_a,$array_b);


// var_dump($new_array);

// var_dump(array_unique($new_array));
